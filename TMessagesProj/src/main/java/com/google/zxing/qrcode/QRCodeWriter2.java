...
public final class QRCodeWriter2 {
  ...
  public Bitmap encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType, ?> hints, Bitmap bitmap, Context context) throws WriterException {
    ...
    imageBloks = Math.round((size - 32) / /*4.65f*/ 4f / multiple);
    ...
    canvas.drawCircle(imageX + imageSize / 2f, imageX + imageSize / 2f, imageSize / 2f, blackPaint);
