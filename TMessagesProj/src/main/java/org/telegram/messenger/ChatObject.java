...
public class ChatObject {
    ...
    public static boolean canSendReactions(TLRPC.ChatFull chatFull) {
        if (chatFull == null || chatFull.available_reactions == null) return false;
        if (chatFull.available_reactions.size() == 0) return false;
