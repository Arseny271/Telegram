...
public class ReactionCheckCell extends FrameLayout {
    ...
    private TLRPC.Document reaction;
    ...
    public ReactionCheckCell(Context context, int padding, boolean dialog) {
        ...
        addView(textView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.TOP, LocaleController.isRTL ? 70 : padding + 50, 0, LocaleController.isRTL ? padding + 50 : 70, 0));
        ...
        addView(imageView, LayoutHelper.createFrame(25, 25, Gravity.CENTER_VERTICAL | (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT), LocaleController.isRTL ? 0: padding, 0, LocaleController.isRTL ? padding : 0, 0));
    ...
    public void setReaction(TLRPC.Document document, Object parent) {
        parentObject = parent;
        if (document != null) {
